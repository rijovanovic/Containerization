...
# Azure Application Insights jar needs a registry key for the performance counters
# For some reason this key is not present in a windows container, we fix that by importing the values
reg.exe import "C:\connect\azure-logs\perflib009.reg"